...
const PrivacyPage: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg mt-10">
      <h1 className="text-3xl font-bold mb-4">Privacy e Trattamento dei Dati Personali</h1>

      <p className="mb-4">
        La tua privacy è importante per noi. Questa pagina descrive come gestiamo i dati personali degli utenti del nostro sito.
      </p>

      <h2 className="text-2xl font-semibold mb-2">Cookie</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mb-2">Raccolta dei dati</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mb-2">Finalità</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mb-2">Diritti dell’utente</h2>
      <p className="mb-4">
